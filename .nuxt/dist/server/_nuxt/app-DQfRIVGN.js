...
import { _ as __nuxt_component_0 } from "./AppButton-DJM0cog_.js";
import { defineComponent, mergeProps, withCtx, createTextVNode, useSSRContext, toDisplayString } from "vue";
import { a as useRuntimeConfig } from "../server.mjs";
import { ssrRenderAttrs, ssrRenderAttr, ssrRenderList, ssrRenderClass, ssrInterpolate, ssrIncludeBooleanAttr, ssrRenderComponent, ssrRenderSlot } from "vue/server-renderer";
import { _ as _export_sfc } from "./_plugin-vue_export-helper-1tPrXgE0.js";
import { u as useEnvironment } from "./useEnvironment-BxGroLsJ.js";
    ...
    async send() {
      ...
      try {
        ...
        this.messages.push({
          ...
          actions: data.actions_taken?.length ? data.actions_taken : void 0
        });
      } catch (e) {
        const err = e;
        this.messages.push({
...
function _sfc_ssrRender$1(_ctx, _push, _parent, _attrs, $props, $setup, $data, $options) {
  ...
  if (_ctx.open) {
    _push(`<!--[--><span class="text-sm font-medium text-white">Aploy assistant</span><span class="text-muted text-xs">◀</span><!--]-->`);
  } else {
...
function _sfc_ssrRender(_ctx, _push, _parent, _attrs, $props, $setup, $data, $options) {
  ...
  _push(`<div${ssrRenderAttrs(mergeProps({ class: "flex min-h-screen bg-surface" }, _attrs))}><aside class="w-56 shrink-0 flex flex-col border-r border-border"><div class="p-4 border-b border-border">`);
...
//# sourceMappingURL=app-DQfRIVGN.js.map
