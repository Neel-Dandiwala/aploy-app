    ...
    async send() {
      ...
      try {
        ...
        this.messages.push({
          ...
          actions: ((_a = data.actions_taken) == null ? void 0 : _a.length) ? data.actions_taken : void 0
        });
      } catch (e) {
        const err = e;
        this.messages.push({
          role: "assistant",
          content: ((_b = err == null ? void 0 : err.data) == null ? void 0 : _b.error) || (err == null ? void 0 : err.message) || "Request failed. Check API key."
        });
      } finally {
        this.loading = false;
      }
...
//# sourceMappingURL=app-DQfRIVGN.mjs.map
