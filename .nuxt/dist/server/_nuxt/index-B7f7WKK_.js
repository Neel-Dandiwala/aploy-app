...
function _sfc_ssrRender(_ctx, _push, _parent, _attrs, $props, $setup, $data, $options) {
  ...
  if (_ctx.loading) {
    ...
    ssrRenderList(_ctx.datasets, (d) => {
      _push(`<tr><td class="font-medium text-zinc-900">${ssrInterpolate(d.name)}</td><td class="text-emerald-500">${ssrInterpolate(d.status)}</td><td class="text-muted-foreground">${ssrInterpolate(d.row_count?.toLocaleString())}</td><td>`);
...
//# sourceMappingURL=index-B7f7WKK_.js.map
