...
function _sfc_ssrRender(_ctx, _push, _parent, _attrs, $props, $setup, $data, $options) {
  ...
  _push(ssrRenderComponent(_component_AppCard, null, {
    default: withCtx((_, _push2, _parent2, _scopeId) => {
      if (_push2) {
        _push2(`<p class="text-muted-foreground text-sm"${_scopeId}>Duration: 3h \xB7 Cost: $14.20 \xB7 Loss: 0.42</p><div class="flex flex-wrap gap-3 mt-4"${_scopeId}>`);
        ...
        return [
          createVNode("p", { class: "text-muted-foreground text-sm" }, "Duration: 3h \xB7 Cost: $14.20 \xB7 Loss: 0.42"),
...
//# sourceMappingURL=_id_-Dhquuj0C.mjs.map
