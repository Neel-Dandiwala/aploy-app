...
function _sfc_ssrRender(_ctx, _push, _parent, _attrs, $props, $setup, $data, $options) {
  ...
  if (_ctx.loading) {
    ...
    ssrRenderList(_ctx.datasets, (d) => {
      var _a;
      _push(`<tr><td class="font-medium text-white">${ssrInterpolate(d.name)}</td><td class="text-emerald-500">${ssrInterpolate(d.status)}</td><td class="text-muted-foreground">${ssrInterpolate((_a = d.row_count) == null ? void 0 : _a.toLocaleString())}</td><td>`);
...
//# sourceMappingURL=index-DAeUGMsg.mjs.map
