    ...
    buildSteps() {
      return this.form.steps.map((s) => {
        ...
        if (s.type === "retrieve") {
          ...
          step.topK = (_a = s.topK) != null ? _a : 5;
          if ((_b = s.queryMapping) == null ? void 0 : _b.trim()) step.queryMapping = s.queryMapping.trim();
        } else if (s.type === "model") {
          step.deploymentId = s.deploymentId || void 0;
          if ((_c = s.inputMappingStr) == null ? void 0 : _c.trim()) {
            try {
        ...
        if ((_d = s.dependsOnStr) == null ? void 0 : _d.trim()) {
...
//# sourceMappingURL=new-DdaWsMTd.mjs.map
