...
import { mergeProps, withCtx, createTextVNode, toDisplayString, createVNode, withDirectives, vModelText, openBlock, createBlock, createCommentVNode, Fragment, renderList, defineComponent, useSSRContext } from 'vue';
    ...
    async runTest() {
      ...
      try {
        ...
        const res = await $fetch(url, {
          ...
          body: input,
          credentials: "include",
          headers: { "Content-Type": "application/json", "X-Environment": (_c = (_b = this.environment) == null ? void 0 : _b.value) != null ? _c : "production" }
        });
        this.testOutput = res.error ? { error: res.error, output: res.output, steps: res.steps } : res.output;
      } catch (e) {
        const err = e;
        this.testOutput = (_d = err.data) != null ? _d : e.message;
      } finally {
        this.running = false;
      }
    }
...
function _sfc_ssrRender(_ctx, _push, _parent, _attrs, $props, $setup, $data, $options) {
  ...
  _push(ssrRenderComponent(_component_AppPageHeader, {
    title: (_b = (_a = _ctx.pipeline) == null ? void 0 : _a.name) != null ? _b : "Pipeline",
    ...
    _push(ssrRenderComponent(_component_AppCard, null, {
      default: withCtx((_, _push2, _parent2, _scopeId) => {
        ...
        if (_push2) {
          ...
          _push2(`<!--]--></ul>`);
          if (!((_a2 = _ctx.pipeline.steps) == null ? void 0 : _a2.length)) {
          ...
          return [
            ...
            !((_b2 = _ctx.pipeline.steps) == null ? void 0 : _b2.length) ? (openBlock(), createBlock("p", {
              key: 0,
...
//# sourceMappingURL=_id_-BISbpQ1a.mjs.map
