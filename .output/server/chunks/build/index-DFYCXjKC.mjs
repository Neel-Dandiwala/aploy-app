...
import { _ as __nuxt_component_0$2 } from './nuxt-link-T1BgcM6o.mjs';
...
function _sfc_ssrRender(_ctx, _push, _parent, _attrs, $props, $setup, $data, $options) {
  ...
  if (_ctx.loading) {
    ...
    ssrRenderList(_ctx.projects, (p) => {
      _push(`<tr><td class="font-medium text-white">${ssrInterpolate(p.name)}</td><td class="text-muted-foreground">${ssrInterpolate(p.base_model)}</td><td class="text-muted-foreground">${ssrInterpolate(p.objective)}</td><td class="text-muted text-sm">${ssrInterpolate(_ctx.formatDate(p.created_at))}</td><td>`);
...
//# sourceMappingURL=index-DFYCXjKC.mjs.map
