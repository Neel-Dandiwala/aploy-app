...
import { defineComponent, mergeProps, withCtx, createTextVNode, toDisplayString, createVNode, withDirectives, openBlock, createBlock, Fragment, renderList, vModelSelect, vModelText, createCommentVNode, useSSRContext } from "vue";
      ...
      default: withCtx((_, _push2, _parent2, _scopeId) => {
        if (_push2) {
          ...
          if (_ctx.responseTime !== null) {
            _push2(`<span class="ml-2"${_scopeId}>· ${ssrInterpolate(_ctx.responseTime)} ms</span>`);
          } else {
            _push2(`<!---->`);
          }
          ...
          return [
            ...
            createVNode("p", { class: "text-sm text-muted-foreground mb-2" }, [
              ...
              _ctx.responseTime !== null ? (openBlock(), createBlock("span", {
                key: 0,
                class: "ml-2"
              }, "· " + toDisplayString(_ctx.responseTime) + " ms", 1)) : createCommentVNode("", true)
            ]),
...
//# sourceMappingURL=api-explorer-DE7tGIc9.js.map
