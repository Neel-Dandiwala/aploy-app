...
function _sfc_ssrRender(_ctx, _push, _parent, _attrs, $props, $setup, $data, $options) {
  ...
  if (_ctx.loading) {
    ...
    ssrRenderList(_ctx.deployments, (d) => {
      _push(`<tr><td class="font-mono text-white text-sm">${ssrInterpolate(d.id)}</td><td class="text-muted-foreground">${ssrInterpolate(d.model_version_id)}</td><td class="text-emerald-500">${ssrInterpolate(d.status)}</td><td class="text-muted-foreground font-mono text-sm">${ssrInterpolate(d.endpoint_url)}</td></tr>`);
    });
    _push(`<!--]--></tbody></table>`);
...
//# sourceMappingURL=index-Bl93NEQ0.mjs.map
